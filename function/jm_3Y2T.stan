/*
This code was modified based on the following paper, where two continuous longitudinal outcomes and one event outcome were modelled jointly using stan. In this code, we extended to 3 longitudinal outcomes (Normal, Normal, and Bernulli distributions) and one main event outcome subject to a dependent censoring outcome.
